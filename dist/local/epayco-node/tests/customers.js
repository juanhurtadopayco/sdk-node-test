...
describe('Customers', function () {
    ...
    describe('#Retrieve', function () {
        it('Retrieve customer', function (done) {
            epayco.customers.get("id_customer").then(function (customer) {
                assert(customer);
            }).catch(function (err) {
                console.log("err: " + err);
            });
    ...
    describe('#List', function () {
        it('List customers', function (done) {
            epayco.customers.list().then(function (customers) {
                assert(customers);
            }).catch(function (err) {
                console.log("err: " + err);
            });
    ...
    describe('#Update', function () {
        it('Update customer', function (done) {
            ...
            epayco.customers.update("id_customer", update_customer_info).then(function (customer) {
                assert(customer);
            }).catch(function (err) {
                console.log("err: " + err);
            });
