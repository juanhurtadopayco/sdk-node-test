...
describe('Subscriptions', function () {
    ...
    describe('#Retrieve', function () {
        it('Retrieve subscription', function (done) {
            epayco.subscriptions.get("id_subscription").then(function (subscription) {
                assert(subscription);
            }).catch(function (err) {
                console.log("err: " + err);
            });
    ...
    describe('#List', function () {
        it('List subscriptions', function (done) {
            epayco.subscriptions.list().then(function (subscriptions) {
    ...
    describe('#Cancel', function () {
        it('Cancel subscription', function (done) {
            epayco.subscriptions.cancel("id_subscription").then(function (subscription) {
                assert(subscription);
            }).catch(function (err) {
                console.log("err: " + err);
            });
