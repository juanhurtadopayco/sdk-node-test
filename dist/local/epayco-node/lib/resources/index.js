...
//const BASE_URL = "https://api.secure.payco.co",
var BASE_URL = "https://api.secure.epayco.io",
    BASE_URL_SECURE = "https://secure.payco.co";
...
Resource.prototype.request = function (method, url, data, sw) {
    ...
    return new Promise(function (resolve, reject) {
        request(method, url).auth(_this._epayco.apiKey, '').set('type', 'sdk').query(method === 'get' && data || {}).send(method !== 'get' && data || {}).end(function (err, res) {
            if (res.ok) {
