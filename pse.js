import {PsePayment,PseGet} from './resources/pse'
...
console.log(action)
if (action === "create") {
    PsePayment(pse_info, "production", "gateway").then((r) => {
        console.log(r);
    ...
    PseGet("250345801622219927", "preprod", "agregador").then((r) => {
        console.log(r);
    })
}
